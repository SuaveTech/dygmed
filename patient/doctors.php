                    ...
                    <td>
                        ...
                        <form action="" method="post" class="header-search">
                            ...
                            <?php
                                ...
                                $list11 = $database->query("select  docname,docemail from  doctor where hospital_id='$hospital_id';");
...
?>
                ...
                <?php
                    if($_POST){
                        ...
                        $sqlmain= "select * from doctor where hospital_id='$hospital_id' order by docid desc ";
                    ...
                    <div id="popup1" class="overlay">
                            ...
                            <center>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="text" name="nic" class="input-text" placeholder="NIN Number" value="'.$nic.'" required><br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label-td" colspan="2">
