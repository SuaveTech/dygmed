...
<body>
    ...
    $query = "SELECT docname, docemail, profile_picture FROM doctor WHERE docid='$userid'";
    $result = $database->query($query);
    $user = $result->fetch_assoc();
    
    $absolute_path = $user['profile_picture'] ?? null; 
            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;" >
                        ...
                        <tr >
                            ...
                            <td width="15%">
                                ...
                                $patientrow = $database->query("select  * from  patient where hospital_id='$hospital_id';");
                                $doctorrow = $database->query("select  * from  doctor where hospital_id='$hospital_id';");
