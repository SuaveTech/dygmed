                    ...
                    <td>
                        ...
                        <form action="" method="post" class="header-search">
                            ...
                            <?php
                                ...
                                $list11 = $database->query("select  pname,pemail from patient where hospital_id='$hospital_id';");
...
?>
                ...
                <?php
                    if($_POST){
                        ...
                        $sqlmain= "select * from patient  where hospital_id='$hospital_id' and pemail='$keyword' or hospital_id='$hospital_id' and pname='$keyword' or hospital_id='$hospital_id' and pname like '$keyword%' or hospital_id='$hospital_id' and pname like '%$keyword' or hospital_id='$hospital_id' and pname like '%$keyword%' ";
                    }else{
                        $sqlmain= "select * from patient where hospital_id='$hospital_id' order by pid desc";
