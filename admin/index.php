            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-doctor ">
                        <a href="hospitals.php" class="non-style-link-menu "><div><p class="menu-text">Hospitals</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row">
            <td class="menu-btn menu-icon-doctor">
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-doctor">
                        <a href="subscriptions.php" class="non-style-link-menu"><div><p class="menu-text">Subscriptions</p></a></div>
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="4">
                        ...
                        <table class="filter-container" style="border: none;" border="0">
                            <tr>
                                <td colspan="4">
                                    <p style="font-size: 20px;font-weight:600;padding-left: 12px;">Welcome Admin</p>
                                </td>
                            </tr>
                            <tr>
